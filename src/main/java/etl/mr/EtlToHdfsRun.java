 ...
 * @version：1.0
 */
public class EtlToHdfsRun implements Tool {
    private static Logger logger = Logger.getLogger(EtlToHdfsRun.class);
    ...
    public int run(String[] args) throws Exception {
        ...
        //System.out.println(job.getConfiguration().get("rundate"));
        job.setJarByClass(EtlToHdfsRun.class);
        ...
        //路径
        //handlePath(job);
        FileInputFormat.addInputPath(job, new Path("C:\\Users\\tqllorry\\Desktop\\in"));
        FileOutputFormat.setOutputPath(job, new Path("C:\\Users\\tqllorry\\Desktop\\out"));
    ...
    public static void main(String[] args) {
        try {
            ToolRunner.run(new Configuration(), new EtlToHdfsRun(), args);
        } catch (Exception e) {
            logger.error("执行异常", e);
        }
    }
