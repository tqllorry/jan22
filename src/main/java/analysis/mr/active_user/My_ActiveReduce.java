 ...
 * @version：1.0
 */
public class My_ActiveReduce extends Reducer<StatsUserDimension, MapOutPutValue, StatsUserDimension, ReduceOutputValue> {
    //private static Logger logger = Logger.getLogger(My_ActiveReduce.class);
