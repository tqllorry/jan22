 ...
 * @version：1.0
 */
public class MyReduce extends Reducer<StatsUserDimension, MapOutPutValue, StatsUserDimension, ReduceOutputValue> {
    private static Logger logger = Logger.getLogger(MyReduce.class);
